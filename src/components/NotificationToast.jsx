...
export default function NotificationToast({ notifications }) {
  ...
  return (
    <div className="float-in fixed bottom-4 right-4 z-50 flex w-[min(24rem,calc(100vw-2rem))] items-start gap-3 rounded-3xl border border-slate-200/90 bg-white/95 p-4 text-slate-800 shadow-xl dark:border-slate-700 dark:bg-slate-900/95 dark:text-slate-200">
      <div className="inline-flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-xl bg-blue-100 text-blue-700 dark:bg-blue-500/20 dark:text-blue-300">
